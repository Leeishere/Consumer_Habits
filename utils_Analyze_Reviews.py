...
def plot_cat_to_review_levels(data,
    ...
    and review_colunm is a review rating level such as Review Rating level 1, 2, or 3
    and n_axis_columns is the number of plots to fit on one row when filling the figure
    """
    ...
    if probabilities==True:
        ...
        grouped['P_category_given_not_review'] = (category_totals - grouped['Count']) / (total_n - review_totals)
